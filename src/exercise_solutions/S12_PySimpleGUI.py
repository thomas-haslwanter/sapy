...
Demonstrates one way of embedding Matplotlib figures into a FreeSimpleGUI window.
...
if __name__ == '__main__':
    ...
    window = sg.Window('Demo Application - Embedding Matplotlib In FreeSimpleGUI',
